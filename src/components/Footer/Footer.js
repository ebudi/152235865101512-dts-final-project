...
const Footer = () => {
    ...
    const footerLink = [
        ...
        { id: 3, text: 'Sudirman Street' },
        { id: 4, text: 'Jakarta, DKI 12000' },
        { id: 5, text: 'Pharmacy Help Line' },
        { id: 6, text: 'Prescribing Tools' },
        { id: 7, text: 'Specialty Medications' },
        { id: 8, text: 'Pharmacy Claims' },
        { id: 9, text: '+ (6221)234-2345' },
        { id: 10, text: '+ (6221)345-2123' },
        { id: 11, text: '+ (6221)345-2156' },
        { id: 12, text: '+ (6221)234-3456' },
    ]
    return (
        <Fade left>
        <footer className="text-gray-600 poppins bg-gray-100">
            ...
            <div className="bg-blue-700">
                <div className="max-w-screen-xl mx-auto py-4 px-5 flex flex-wrap flex-col justify-center sm:flex-row">
                    <p className="text-white text-sm text-center sm:text-left">© 2022 Development by Pharmacy
                        <a href="/" rel="noopener noreferrer" className="text-white ml-1">Person</a>
                    </p>
                </div>
            </div>
        </footer>
